                                ...
                                <div class="table-responsive">
                                    <table
                                        ...
                                        if(isset($_GET['fromdate']) && isset($_GET['todate']))
                                        {
                                            ...
                                            $query="SELECT * FROM invoice_master im JOIN invoice i ON im.invoice_no=i.invoice_no JOIN item it ON im.item_id=it.item_id JOIN 
                                            customer c ON i.customer=c.id WHERE i.date BETWEEN '$fromdate' AND '$todate'";
